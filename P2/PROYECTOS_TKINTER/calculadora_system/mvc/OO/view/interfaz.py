...
class Vista:
    ...
    def menuPrincipal(ventana):
        ...
        archivoMenu.add_command(label="Cambiar",command=lambda: Vista.interfaz_cambiar(ventana))
    ...
    def interfaz_cambiar(ventana):
        ...
        Label(ventana, text=".:: Cambiar una Operación ::.", font=("Arial", 14)).pack(pady=5)
        ...
        txt_id = Entry(frame_campos, textvariable=id_operacion, width=20)
