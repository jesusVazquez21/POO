...
from notas.model.notas import Nota
import getpass
...
def main():
    ...
    while opcion:
        ...
        if opcion == "1" or opcion == "REGISTRO":
            ...
            apellidos = input("\t Ingresa tus apellidos?: ").upper().strip()
            ...
            if resultado:
                ...
                print("\n\t..:: No fue posible insertar el registro, por favor inténtelo de nuevo ::..")
...
def menu_notas(usuario_id, nombre, apellidos):
    ...
    while opc:
        ...
        if opcion == '1' or opcion == "CREAR":
            ...
            if respuesta:
                print(f"..:: Se creó la nota {titulo} exitosamente ::..")
            else:
            ...
            if lista_notas:
                ...
                for fila in lista_notas:
                    fecha_str = fila[4].strftime("%Y-%m-%d %H:%M:%S") if fila[4] else "Sin fecha"
                    print(f"{fila[0]:<5} | {fila[2]:<20} | {fila[3]:<40} | {fecha_str}")
